...
<head>
  ...
  <title>Tienda Electronica | Online</title>
...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Andres Espino</span>
            </a>
            <ul class="dropdown-menu">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2018 <a href="#">AndresEspn</a>.</strong> All rights reserved.
  </footer>
